...
// main.c
// Runs on TM4C123
// Lab2_HelloLauncPad, Input from PF4, output to PF3, PF2, PF1 (LED)
...
// Constant declarations to access port register using
...
// Global Variables
unsigned long In;  // input form PF4
unsigned long Out; // output to PF3, PF2, PF1 (multicolor LED)
...
void PortF_Init(void){
	...
	GPIO_PORTF_AMSEL = 0x00;          // 3) disable analog function
